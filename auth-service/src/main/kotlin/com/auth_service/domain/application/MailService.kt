...
class MailService(private val mailSender: JavaMailSender) {
    ...
    companion object {
        ...
        private fun makeVerifyingContentWithCode(code: String) =
            ...
            "<img class='logo' src='cid:image'>" +
            "<h1 style='padding-top: 50px; font-size: 30px;'>이메일 주소 인증</h1>" +
            "<p style='padding-top: 20px; font-size: 18px; opacity: 0.6; line-height: 30px; font-weight: 400;'>안녕하세요? SoundBind 관리자 입니다.<br />" +
            "SoundBind 서비스 사용을 위해 회원가입시 고객님께서 입력하신 이메일 주소의 인증이 필요합니다.<br />" +
            "하단의 인증 번호로 이메일 인증을 완료하시면, 정상적으로 SoundBind 서비스를 이용하실 수 있습니다.<br />" +
            "항상 최선의 노력을 다하는 SoundBind가 되겠습니다.<br />" +
            "감사합니다.</p>" +
            "<div class='code-box' style='margin-top: 50px; padding-top: 20px; color: #000000; padding-bottom: 20px; font-size: 25px; text-align: center; background-color: #f4f4f4; border-radius: 10px;'>" + code + "</div>" +
            "</body></html>"
    }
}